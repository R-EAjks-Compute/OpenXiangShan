...
class MicroTage1Table(
    val numSets:       Int,
    val histLen:       Int,
    val tagLen:        Int,
    val histBitsInTag: Int,
    val tableId:       Int
)(implicit p: Parameters) extends MicroTage1Module with Helpers {
  class MicroTageTableIO extends MicroTage1Bundle {
  ...
  class MicroTageEntry() extends MicroTage1Bundle {
    val valid:       Bool            = Bool()
