...
class MicroTage1Prediction(implicit p: Parameters) extends MicroTage1Bundle {
  val taken:       Bool                 = Bool()
  val cfiPosition: UInt                 = UInt(CfiPositionWidth.W)
  val meta:        Valid[MicroTage1Meta] = Valid(new MicroTage1Meta)
}
class MicroTage1Meta(implicit p: Parameters) extends MicroTage1Bundle {
