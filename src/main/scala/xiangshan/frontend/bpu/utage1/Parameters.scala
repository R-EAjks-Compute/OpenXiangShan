...
case class MicroTage1Parameters(
...
trait HasMicroTage1Parameters extends HasBpuParameters {
  val utage1Parameters: MicroTage1Parameters = MicroTage1Parameters()
  def TableInfos:      Seq[MicroTageInfo]  = utage1Parameters.TableInfos
  def TakenCtrWidth:   Int                 = utage1Parameters.TakenCtrWidth
  def TagWidth:        Int                 = utage1Parameters.TagWidth
  def NumTables:       Int                 = utage1Parameters.NumTables
  def TickWidth:       Int                 = utage1Parameters.TickWidth
  def UsefulWidth:     Int                 = utage1Parameters.UsefulWidth
  def BaseTableSize:   Int                 = utage1Parameters.BaseTableSize
